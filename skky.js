...
module.exports = {
  ...
  allGood: function (iot, hasObject) {
    if (this.isNullOrUndefined(iot)) return false

    var good = this.isNullOrUndefined(iot.code) || iot.code >= 0
    if (good && (iot.err || []).length > 0) good = false
  ...
  addObjectToList: function (objarr, obj) {
    ...
    while (true) {
      ...
      if (this.isNullOrUndefined(geto)) break
  ...
  hasData: function (o, minlength) {
    ...
    if (this.isNullOrUndefined(o)) return false

    if (this.isNullOrUndefined(minlength)) minlength = 1

    if (this.isString(o) || this.isArray(o)) return o.length >= minlength

    // Objects and primitives will not have any length.
    if (!this.isObject(o)) return minlength <= 1
  ...
  isArray: function (o, minLength) {
    var isok =
      this.isObject(o) && Object.prototype.toString.call(o) == '[object Array]'
    //('number' === typeof (o.length)) && (o.propertyIsEnumerable && !o.propertyIsEnumerable('length')));
    if (isok) isok = o.length >= (minLength || 0)
  ...
  nonNull: function (s, obj) {
    if (this.hasData(s)) return s

    if (this.isNullOrUndefined(s) && !this.isNullOrUndefined(obj)) return obj
  ...
  addConstantToObject: function (toObject, name, value, isEnumerable) {
    if (this.isNullOrUndefined(isEnumerable)) isEnumerable = true
  ...
  addConstant: function (name, value, isEnumerable) {
    return this.addConstantToObject(
      this.getConstants(),
      name,
      value,
      isEnumerable
  ...
  getApp: function (name) {
    if (this.isNullOrUndefined(this.app)) this.app = {}

    return this.getObject(this.app, name)
  },
  getAppConfig: function (name) {
    var app = this.getApp()
    if (this.isNullOrUndefined(app.config)) app.config = {}

    return this.getObject(app.config, name)
  },
  getAppConstants: function (name) {
    var app = this.getApp()
    if (this.isNullOrUndefined(app.constants)) app.constants = {}
  ...
  getConstants: function () {
    if (this.isNullOrUndefined(this.constants)) this.constants = {}
  ...
  compareField: function (srcObj, destObj, fieldName) {
    try {
      if (skky.isNullOrUndefined(srcObj[fieldName])) return false
